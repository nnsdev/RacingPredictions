...
class CarSeeder extends Seeder
{
    ...
    public function run()
    {
        collect([
            ...
            [35, 'SMP Racing', '', 'lmp2', ['Victor Shaitar', 'Harrison Newey', 'Norman Nato']],
            ...
            [39, 'Graff-SO24', 'lmp2', 'Oreca 07 - Gibson', ['Vincent Capillaire', 'Jonathan Hirschi', 'Tristan Gommendy']],
            [40, 'G-Drive Racing', 'lmp2', 'Oreca 07 - Gibson', ['James Allen', 'Jose Gutierrez', 'Enzo Guibbert']],
            [44, 'Eurasia Motorsport', 'lmp2', 'Ligier JSP217 - Gibson', ['Andrea Bertolini', 'Nic Jönsson', 'Tracy Krohn']],
            [47, 'Cetilar Villora Corse', 'lmp2', 'Dallara P217 - Gibson', ['Roberto Lacorte', 'Giorgio Sernagiotto', 'Felipe Nasr']],
            ...
            [51, 'AF Corse', 'gtepro', 'Ferrari 488 GTE EVO', ['Alessandro Pier Guidi', 'James Calado', 'Daniel Serra']],
            [52, 'AF Corse', 'gtepro', 'Ferrari 488 GTE EVO', ['Toni Vilander', 'Antonio Givinazzi', 'Luis Felipe Derani']],
            [63, 'Corvette Racing', 'gtepro', 'Chevrolet Corvette C7.R', ['Jan Magnussen', 'Antonio Garcia', 'Mike Rockenfeller']],
            [64, 'Corvette Racing', 'gtepro', 'Chevrolet Corvette C7.R', ['Oliver Gavin', 'Tommy Milner', 'Marcel Fässler']],
            ...
            [80, 'Ebimotors', 'gteam', 'Porsche 911 RSR', ['Fabio Babini', 'Christina Nielsen', 'Erik Maris']],
            [84, 'JMW Motorsport', 'gteam', 'Ferrari 488 GTE EVO', ['Liam Griffin', 'Cooper MacNeil', 'Jeff Segal']],
            [85, 'Keating Motorsport (Risi)', 'Ferrari 488 GTE EVO', 'gteam', ['Ben Keating', 'Jeroen Beekemolen', 'Luca Stolz']],
            [86, 'Gulf Racing', 'gteam', 'Porsche 911 RSR', ['Mike Wainwright', 'Ben Barker', 'Alex Davison']],
            [88, 'Dempsey-Proton Racing', 'Porsche 911 RSR', 'gteam', ['Matteo Cairoli', 'Khaled Al Qubaisi', 'Giorgio Roda']],
            [90, 'TF Sport', 'gteam', 'Aston Martin Vantage AMR', ['Salih Yoluc', 'Euan Hankey', 'Charlie Eastwood']],
